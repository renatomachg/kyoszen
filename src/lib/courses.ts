...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    badge: "Nuevo",
    instructor: "Equipo Kyoszen",
    instructorBio: "Consultores en gestion de procesos y proyectos con experiencia en estandarizacion y documentacion operativa en empresas mexicanas.",
    color: "#bbf7d0",
    iconColor: "#15803d",
    initials: "DF",
    descripcionCorta: "Aprende a elaborar diagramas de procesos para estandarizar operaciones y cronogramas de actividades para optimizar tiempos y resultados de proyectos.",
    descripcionLarga: [
      "Aprenderas a realizar el diagrama de un proceso para lograr la estandarizacion en la operacion de las tareas y responsabilidades con el fin de alcanzar un resultado deseado, contribuyendo asi al logro de los objetivos de la organizacion.",
      "Del mismo modo aprenderas a llevar a cabo cronogramas de actividades para optimizar los tiempos y resultados de los proyectos propios de la organizacion, para la obtencion de beneficios propios y para el cliente.",
    ],
    aprenderas: [
      "Administrar procesos: estrategias y analisis",
      "Construir diagramas de flujo con simbologia estandar",
      "Aplicar normas ASME, ANSI, ISO y DIN",
      "Elaborar manuales de diagramas de flujo",
      "Diseñar cronogramas con Gantt y PERT",
      "Dar seguimiento y evaluar cronogramas de proyecto",
    ],
    dirigido: [
      "Responsables de procesos y operaciones",
      "Coordinadores y lideres de proyecto",
      "Analistas y documentadores de procesos",
      "Emprendedores que estandarizan operaciones",
    ],
    requisitos: [
      "Sin requisitos previos",
    ],
    contenido: [
      {
        titulo: "Administracion de procesos",
        descripcion: "Que es un proceso · Elementos que lo conforman · Estrategias y analisis de procesos.",
        duracion: "3.5 h",
      },
      {
        titulo: "Diagramas de flujo",
        descripcion: "Definicion, antecedentes y normas de trabajo · Caracteristicas · Tipos y ventajas · Simbologia y significado · Cursograma · Software de diseño.",
        duracion: "5 h",
      },
      {
        titulo: "Manual para elaborar un diagrama de flujo",
        descripcion: "Introduccion y ventajas · Contenido del manual · Objetivos y utilidad · Construccion · Criterios de diseño · Simbologia ASME, ANSI, ISO, DIN, DO, DIF.",
        duracion: "4 h",
      },
      {
        titulo: "Cronograma de actividades",
        descripcion: "Que es y para que sirve · Como hacerlo · Informacion y pasos · Gestion de proyectos: Gantt y PERT · Seguimiento y evaluacion.",
        duracion: "3.5 h",
      },
    ],
    incluye: [
      "Constancia con validez oficial DC-3",
      "Plantillas de diagramas de flujo y Gantt",
      "Biblioteca de simbologia estandar",
      "Casos practicos de estandarizacion",
    ],
    contactEmail: "cursos@kyoszen.com",
  },
  {
    ...
    badge: null,
    instructor: "Equipo Kyoszen",
    instructorBio: "Especialistas en desarrollo humano y comunicacion organizacional con experiencia facilitando habilidades blandas en equipos de trabajo.",
    color: "#fff3b0",
    iconColor: "#b45309",
    initials: "CA",
    ...
    descripcionLarga: [
      "Incrementaras tus conocimientos generales sobre comunicacion, conoceras la importancia y beneficios de la comunicacion asertiva.",
      "Podras poner en practica las habilidades adquiridas que te permitan tener una comunicacion asertiva, tanto en el ambito personal como en el profesional.",
    ],
    aprenderas: [
      "Definir comunicacion y sus componentes socio-psicologicos",
      "Distinguir niveles: intrapersonal, interpersonal, publica, grupal",
      "Dominar formas de comunicacion: verbal, no verbal, escrita",
      "Identificar factores que influyen en la comunicacion",
      "Aplicar tecnicas de comunicacion asertiva",
      "Desarrollar habilidades sociales y entrenamiento asertivo",
    ],
    dirigido: [
      "Lideres y mandos medios",
      "Profesionistas que interactuan con clientes o equipos",
      "Personas que desean mejorar relaciones personales",
      "Equipos de trabajo que buscan mejor comunicacion interna",
    ],
    requisitos: [
      "Sin requisitos previos",
    ],
    contenido: [
      {
        titulo: "Comunicacion",
        descripcion: "Definicion · Importancia · Elementos que intervienen · Componentes socio-psicologicos.",
        duracion: "2.5 h",
      },
      {
        titulo: "Niveles de comunicacion",
        descripcion: "Intrapersonal · Interpersonal · Publica · Grupal.",
        duracion: "2.5 h",
      },
      {
        titulo: "Formas de comunicacion",
        descripcion: "Verbal · No verbal · Escrita.",
        duracion: "2.5 h",
      },
      {
        titulo: "Factores que influyen en la comunicacion",
        descripcion: "Percepcion · Valores y creencias · Aspectos sociales, culturales y familiares · Estado de animo.",
        duracion: "3 h",
      },
      {
        titulo: "Comunicacion asertiva",
        descripcion: "Asertividad · Tecnicas de comunicacion asertiva · Habilidades sociales · Comunicacion asertiva en organizaciones · Entrenamiento asertivo.",
        duracion: "3.5 h",
      },
    ],
    incluye: [
      "Constancia con validez oficial DC-3",
      "Ejercicios practicos de entrenamiento asertivo",
      "Guia de tecnicas de comunicacion efectiva",
      "Role-plays y casos reales",
    ],
    contactEmail: "cursos@kyoszen.com",
  },
  {
    ...
    badge: "Popular",
    instructor: "Equipo Kyoszen",
    instructorBio: "Auditores lideres certificados en normas ISO con experiencia formando equipos auditores en empresas certificadas en Mexico.",
    color: "#bbf7d0",
    iconColor: "#15803d",
    initials: "AI",
    descripcionCorta: "Domina la metodologia para realizar auditorias internas del Sistema de Gestion de Calidad con entrenamiento teorico-practico basado en la normatividad actual.",
    descripcionLarga: [
      "Conoceras la metodologia necesaria para la realizacion de auditorias internas de una organizacion, asi como contar con los conocimientos para auditar un Sistema de Gestion de Calidad, basadas en la normatividad actual y a traves de un entrenamiento teorico-practico.",
      "Aprenderas a planear, organizar y ejecutar una auditoria al sistema de gestion de la calidad en tu organizacion, asi como elaborar el informe de los resultados de auditoria del sistema de gestion de la calidad de una organizacion.",
    ],
    aprenderas: [
      "Dominar definiciones clave: auditoria, criterios, evidencia, hallazgos, NC",
      "Aplicar principios y tipos de auditoria",
      "Desarrollar competencias del auditor lider y del equipo auditor",
      "Planear y gestionar un programa de auditoria completo",
      "Ejecutar listas de verificacion y tecnicas de muestreo/rastreo",
      "Elaborar reportes de auditoria y clasificar no conformidades",
    ],
    dirigido: [
      "Auditores internos en formacion",
      "Responsables de calidad y SGC",
      "Consultores de certificacion ISO 9001",
      "Mandos medios de empresas certificadas",
    ],
    requisitos: [
      "Conocimientos previos de ISO 9001 o sistemas de gestion",
      "Experiencia en procesos empresariales",
    ],
    contenido: [
      {
        titulo: "Que es y para que sirve una auditoria",
        descripcion: "Definiciones: auditoria, criterios, evidencia, hallazgos, conclusiones, riesgo, conformidad, NC · Objetivos y propositos · Entrevistas · Beneficios.",
        duracion: "4.5 h",
      },
      {
        titulo: "Conceptos basicos de las auditorias",
        descripcion: "Principios de auditoria · Tipos de auditoria · Auditoria interna.",
        duracion: "3.5 h",
      },
      {
        titulo: "Responsabilidad de los auditores",
        descripcion: "Competencia y evaluacion · Auditor lider vs auditor · Criterios de calificacion · Habilidades fundamentales · Escucha activa · Construccion de confianza.",
        duracion: "5 h",
      },
      {
        titulo: "Plan de auditoria",
        descripcion: "Plan de auditoria · Gestion de un programa: generalidades, diagrama de flujo, objetivos, establecimiento, implementacion, monitoreo y mejora.",
        duracion: "5 h",
      },
      {
        titulo: "Auditoria",
        descripcion: "Lista de verificacion · Evidencia objetiva · Tecnicas: comprobacion, muestreo, rastreo · Argucias de auditados · Cierre · Reporte y clasificacion de NC (mayor/menor).",
        duracion: "6 h",
      },
    ],
    incluye: [
      "Constancia con validez oficial DC-3",
      "Certificado de Auditor Interno ISO",
      "Plantillas de listas de verificacion y reportes",
      "Simulacion practica de auditoria completa",
    ],
    contactEmail: "cursos@kyoszen.com",
  },
  {
