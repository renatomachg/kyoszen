...
export default function Newsletter() {
  return (
    <section className="bg-bg py-10 px-[5%] border-t border-border">
      <AnimatedSection className="max-w-[480px] mx-auto text-center">
        ...
        <div className="flex gap-2 bg-white border-[1.5px] border-border rounded-[10px] p-1 pl-3.5">
          <input
            type="email"
            placeholder="Tu correo electronico"
            className="flex-1 bg-transparent border-none outline-none text-[13px] text-navy placeholder:text-[#bbb]"
          />
          <button className="bg-blue-btn text-white border-none rounded-[10px] py-2.5 px-5 text-[13px] font-bold cursor-pointer hover:bg-blue-dark transition-colors">
            Suscribirse
          </button>
        </div>
      </AnimatedSection>
